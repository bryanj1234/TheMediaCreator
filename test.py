...
# ret_vals = blim.get_information_about_one_or_more_images_using_functions(prompt, openai_client, urls=urls, file_names=file_names)
# pprint(ret_vals)
...
ret_vals = blim.get_information_about_one_or_more_images_using_response_formatting(prompt, openai_client, urls=urls, file_names=file_names)
pprint(ret_vals)