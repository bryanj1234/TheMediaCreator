...
# answer_struct_func = blp.get_default_question_answer_structure
...
# answer_struct_func = blp.get_multipart_question_answer_structure
...
prompt = blp.create_json_prompt_from_prompt_list(prompt_list)
ret_vals = blim.get_info_about_images(prompt, openai_client, urls=urls, file_names=file_names)
prompts = ret_vals["prompts"]
responses = ret_vals["responses"]
for key in prompts:
    print()
    print(key + ": " + prompts[key])
    print(key + ": " + str(responses[key]))
